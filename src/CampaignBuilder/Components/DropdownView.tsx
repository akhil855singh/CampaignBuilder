...
function DropdownView({ parentId, dropdownProps, openSelection }: Props) {
    ...
    useEffect(() => {
        ...
        case DropdownType.DECISION:
            ...
            break
        default:
            data = ["hell", "Mello", "Gello", "hell", "Mello", "Gello"]
            setFilteredData(data)
            break
        }
            ...
            <div style={ {
                ...
                <Flex justifyContent="space-between">
                    ...
                    <Button
                        ...
                        w="3"
                        leftIcon={ <RiCornerRightUpLine style={ { fontSize: 20, transform: "translate(4px, 0px)" } }
                            onClick={ () => triggerHandleClick(parentId) }
                        /> }
                        bg={ dropdownProps.dropdownColor } h={ 7 }>
                    </Button>
                </Flex>
                <div
